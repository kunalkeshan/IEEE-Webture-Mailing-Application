                                                ...
                                                <tbody>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size: 0px;">
                                                                                            <a target="_blank"><img src="https://vhqpcs.stripocdn.email/content/guids/CABINET_f3fc38cf551f5b08f70308b6252772b8/images/96671618383886503.png" alt style="display: block;" width="100"></a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text es-p15t es-p15b es-m-txt-c" esd-links-underline="none">
                                                                                            <h1 style="color: #97cccf;">Thanks for joining us!</h1>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left" class="esd-block-text es-p30t es-p10b es-p30r es-p30l">
                                                                                            <p style="font-size: 16px; line-height: 150%; color: #97cccf;">Hello ${name}, Thanks for joining us!<br><br>Webture is a 14hrs bootcamp conducted by IEEE SRM on MERN&nbsp;stack web development on 11th and 12th June, 2022.&nbsp;<br><br>If unable to make payment for Webture using the following QR, please visit our nearest Kiosk Counters. Our team will facilitate you throughout the process. You can visit any of the following locations to confirm your payment and your ticket.<br><br>- University Building, UB<br>- Tech Park, TP<br><br><em><strong>Please note that all paid devos will be receiving a ticket to enter the world of Webture!</strong></em><br><br>Use this token for your reference: <b>${token}</b><br><br><br></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td class="esd-structure esdev-adapt-off es-p20" align="left">
                                                            <table width="550" cellpadding="0" cellspacing="0" class="esdev-mso-table">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="esdev-mso-td" valign="top">
                                                                            <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td width="143" align="left" class="esd-container-frame">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="center" class="esd-block-image" style="font-size: 0px;">
                                                                                                            <a target="_blank"><img class="adapt-img" src="https://vhqpcs.stripocdn.email/content/guids/CABINET_d7431fe52e08627caf4c267fa40f1bcd/images/payment.jpeg" alt style="display: block;" width="121"></a>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="155" align="left" class="esd-container-frame">
                                                                                            <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#e8eafb" style="background-color: #e8eafb; border-radius:0 10px 10px 0; border-collapse: separate;">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="center" class="esd-block-text" bgcolor="#010000">
                                                                                                            <p style="font-size: 18px; color: #97cccf;"><strong><em>Use this QR code to do your transactions!</em></strong></p>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                    ...
                                                                    <tr>
                                                                        <td width="550" class="esd-container-frame" align="center" valign="top">
                                                                            <table cellpadding="0" cellspacing="0" width="100%" style="border-radius: 5px; border-collapse: separate;">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="left" class="esd-block-text es-p20t es-p10b" esd-links-underline="underline">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="center" valign="top" class="es-p40r">
                                                                                                            <a target="_blank" href="https://www.facebook.com/ieeesrmist/"><img title="Facebook" src="https://vhqpcs.stripocdn.email/content/assets/img/social-icons/circle-black/facebook-circle-black.png" alt="Fb" width="32"></a>
                                                                                                        </td>
                                                                                                        <td align="center" valign="top" class="es-p40r">
                                                                                                            <a target="_blank" href="https://twitter.com/ieeesrmist"><img title="Twitter" src="https://vhqpcs.stripocdn.email/content/assets/img/social-icons/circle-black/twitter-circle-black.png" alt="Tw" width="32"></a>
                                                                                                        </td>
                                                                                                        <td align="center" valign="top">
                                                                                                            <a target="_blank" href="https://www.instagram.com/ieeesrmist/?hl=en"><img title="Instagram" src="https://vhqpcs.stripocdn.email/content/assets/img/social-icons/circle-black/instagram-circle-black.png" alt="Inst" width="32"></a>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
